...
void setup() {
  ...
  img2=loadImage("sky3.jpg");
  img3=loadImage("sky2.jpg");
  img=loadImage("sky.jpg");
  img4=loadImage("sky4.jpg");
...
void draw() {
  ...
  if (day) {
    textureSphere(2500, 2500, 2500, img);
  }
  if (dusk) {
    textureSphere(2500, 2500, 2500, img3);
  }
  if (night) {
    textureSphere(2500, 2500, 2500, img2);
  }
  if (cartoon) {
    textureSphere(2500, 2500, 2500, img4);
  }
  drawBoids();
